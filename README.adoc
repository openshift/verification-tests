...
# or execute the smoke testsbundle exec cucumber --tags @smoke
----
...
It is in `.gitignore` so thatyou can keep your test scenarios under the same file system tree without git messing them up.
