...
Feature: TSB related scenarios
  ...
  Scenario: upgrade TSB - prepare
    ...
    #   | f | https://raw.githubusercontent.com/jianzhangbjz/v3-testfiles/tsb-upgrade/olm/art-secret-template.yaml |
    #   | p | NAME=aosqe4-secret                                                                                   |
    #   | p | TOKEN=<your quay token>                                                                              |
    # Then the step should succeed
    # When I process and create:
    #   | f | https://raw.githubusercontent.com/jianzhangbjz/v3-testfiles/tsb-upgrade/olm/operatorsource-template.yaml |
    ...
    When I process and create:
      | f | https://raw.githubusercontent.com/jianzhangbjz/v3-testfiles/tsb-upgrade/olm/asb-cr-template.yaml |
    Then the step should succeed
    And I wait up to 180 seconds for the steps to pass:
    """
    And a pod becomes ready with labels:
