...
Feature: TSB related scenarios
  ...
  Scenario: upgrade TSB - prepare
    ...
    #   | f | https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/olm/art-secret-template.yaml |
    ...
    When I process and create:
      | f | https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/olm/asb-cr-template.yaml |
    Then the step should succeed
    And I wait up to 180 seconds for the steps to pass:
    """
    And a pod becomes ready with labels:
