...
Given /^logging operators are installed with:$/ do | table |
  ...
  unless project('openshift-logging').exists?
    ...
    namespace_yaml = "https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/logging/clusterlogging/deploy_clo_via_olm/4.2/01_clo_ns.yaml"
  ...
  unless project('openshift-operators-redhat').exists?
    eso_namespace_yaml = "https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/logging/eleasticsearch/deploy_via_olm/4.2/01_eo-project.yaml"
  ...
  opts[:clo_operator_group_yaml] ||= "https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/logging/clusterlogging/deploy_clo_via_olm/4.2/02_clo_og.yaml"
  ...
  opts[:eo_operator_group_yaml] ||= "https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/logging/eleasticsearch/deploy_via_olm/4.2/02_eo-og.yaml"
  @result = admin.cli_exec(:create, f: opts[:eo_operator_group_yaml])
  raise "Error creating operatorgroup" unless @result[:success]

  # create RBAC object in `openshift-operators-redhat` namespace
  opts[:operator_group_yaml] ||= "https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/logging/eleasticsearch/deploy_via_olm/4.2/03_eo-rbac.yaml"
  ...
  if cb.ocp_cluster_version.include? "4.1."
    ...
    opts[:catsrc_elasticsearch_yaml] ||= "https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/logging/eleasticsearch/deploy_via_olm/4.1/03_eo-csc.yaml"
  ...
  elsif cb.ocp_cluster_version.include? "4.2."
    # create subscription in `openshift-logging` and "openshift-operators-redhat" namespace:
