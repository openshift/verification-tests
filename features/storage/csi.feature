Feature: CSI testing related feature
  ...
  Scenario Outline: Configure 'Retain' reclaim policy
    ...
    Examples:
      | case_id   | sc_name      |
      | OCP-24575 | gp2-csi      | # @case_id OCP-24575
    ...
    Examples:
      | case_id   | sc_name      |
      | OCP-37572 | standard-csi | # @case_id OCP-37572
  ...
  Scenario Outline: CSI dynamic provisioning with default fstype
    ...
    Examples:
      | case_id   | sc_name      |
      | OCP-37562 | standard-csi | # @case_id OCP-37562
  ...
  Scenario Outline: CSI dynamic provisioning with fstype
    ...
    Examples:
      ...
      | OCP-37560 | standard-csi  | xfs    | # @case_id OCP-37560
      | OCP-37558 | standard-csi  | ext4   | # @case_id OCP-37558
  ...
  Scenario Outline: CSI dynamic provisioning with block
    ...
    Examples:
      | case_id   | sc_name      |
      | OCP-37564 | standard-csi | # @case_id OCP-37564
    ...
    Examples:
      | case_id   | sc_name      |
      | OCP-37511 | standard-csi | # @case_id OCP-37511
  ...
  Scenario Outline: CSI dynamic provisioning with different type
    ...
    Examples:
      ...
      | OCP-24546 | gp2-csi      | sc1    | 125Gi | # @case_id OCP-24546
      | OCP-24572 | gp2-csi      | st1    | 125Gi | # @case_id OCP-24572
    ...
    Examples:
      | case_id   | sc_name      | type   | size  |
      | OCP-37478 | standard-csi | pd-ssd | 1Gi   | # @case_id OCP-37478
  ...
  Scenario Outline: Check CSI Driver Operator installation
    ...
    Examples:
      ...
      | OCP-37557 | cinder.csi.openstack.org | standard-csi | openstack-cinder-csi-driver-operator | openstack-cinder-csi-driver-controller | openstack-cinder-csi-driver-node | # @case_id OCP-37557

    @aws-ipi
    @aws-upi
    Examples:
      | case_id   | provisioner              | sc_name      | deployment_operator                  | deployment_controller                  | daemonset_node                   |
      | OCP-34144 | ebs.csi.aws.com          | gp2-csi      | aws-ebs-csi-driver-operator          | aws-ebs-csi-driver-controller          | aws-ebs-csi-driver-node          | # @case_id OCP-34144
    ...
    Examples:
      | case_id   | provisioner              | sc_name      | deployment_operator                  | deployment_controller                  | daemonset_node                   |
      | OCP-37474 | pd.csi.storage.gke.io    | standard-csi | gcp-pd-csi-driver-operator           | gcp-pd-csi-driver-controller           | gcp-pd-csi-driver-node           | # @case_id OCP-37474
