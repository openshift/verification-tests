Feature: Testing the isolation during build scenarios
  ...
  Scenario Outline: Build-container is constrained to access other projects pod for multitenant plugin
    ...
    Examples:
      ...
      | OCP-15741 | Docker | https://github.com/zhaozhanqi/ruby-docker-test/#isolation      | dockerStrategy | # @case_id OCP-15741
      | OCP-15734 | sti    | ruby~https://github.com/zhaozhanqi/ruby-docker-test/#isolation | sourceStrategy | # @case_id OCP-15734
  ...
  Scenario Outline: Build-container is constrained to access other projects pod for networkpolicy plugin
    ...
    Examples:
      | case_id   | type   | repo                                                           | strategy       |
      | OCP-15731 | Docker | https://github.com/zhaozhanqi/ruby-docker-test/#isolation      | dockerStrategy | # @case_id OCP-15731
      | OCP-15744 | sti    | ruby~https://github.com/zhaozhanqi/ruby-docker-test/#isolation | sourceStrategy | # @case_id OCP-15744
