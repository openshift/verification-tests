...
Feature: cluster-logging-operator related test
  ...
  Scenario: CLO should generate Elasticsearch Index Management
    ...
    And the expression should be true> elasticsearch('elasticsearch').rollover_max_age(name: "app-policy") == "60m"
    ...
    And the expression should be true> elasticsearch('elasticsearch').rollover_max_age(name: "infra-policy") == "3h"
    ...
    And the expression should be true> elasticsearch('elasticsearch').rollover_max_age(name: "audit-policy") == "1d"
