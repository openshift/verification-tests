...
#fipsStatus: fips enabled("1")/disabled("0") type: string
	...
	@admin = myworld.admin
        ...
        @uri = @admin.cli_exec(:get, resource: "infrastructure", o: "jsonpath='{..status.apiServerURL}'")[:stdout]
	@version = getClusterVersion()
	@datajs = @admin.cli_exec(:get, resource: "nodes", o: "json")
 	@data = JSON.parse(@datajs[:stdout])
  	@clusterEnv = @admin.cli_exec(:get, resource: "infrastructure", o: "jsonpath='{..status.platform}'")[:stdout]
