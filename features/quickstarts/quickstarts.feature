Feature: quickstarts.feature
  ...
  Scenario Outline: quickstart test
    ...
    Examples: OS Type
      ...
      | OCP-12296 | rails-postgresql-example | rails-postgresql-example | Rails       | 2     | # @case_id OCP-12296
      | OCP-13749 | dotnet-example           | dotnet-example           | ASP.NET     | 1     | # @case_id OCP-13749
      | OCP-17826 | openjdk18-web-basic-s2i  | openjdk-app              | Hello World | 1     | # @case_id OCP-17826
