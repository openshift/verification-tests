Feature: Event related scenarios
  ...
  # @case_id OCP-10750
  @inactive
  Scenario: OCP-10750:Node Check normal and warning information for kubernetes events
    Given I have a project
  ...
  # @case_id OCP-10208
  @inactive
  Scenario: OCP-10208:Node Event should show full failed reason when readiness probe failed
    Given I have a project
